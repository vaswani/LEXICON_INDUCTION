...
/*
 * $Id: TestPDF.java,v 1.1 2007/12/10 02:13:32 aria42 Exp $
 * $Name:  $
 *
...
public class TestPDF {
    ...
    public static void main(String[] args) {
        ...
        try {
        	// step 2
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("/Users/taylor/Desktop/arabictext.pdf"));
            ...
            g2.drawRoundRect(10, 10, 50, 50, 10, 10);
            g2.dispose();
