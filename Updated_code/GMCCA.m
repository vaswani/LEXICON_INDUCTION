classdef GMCCA
    ...
    methods(Static)
        ...
        function run(exp_id, maxN, lambda, M, K, weight_type,sname,tname,lname)
...
%             target.filename = './data/FEB3_es.features.10k_es.syns.v1.mat';
           ...
           % lexicon.filename = 'data/wiktionary_bilexicon_en-es.mat'; 
            ...
            %source.filename = './data/english_1_features_english_1_2000_30.mat';
            %target.filename = './data/spanish_1_features_spanish_1_30.mat';
            %lexicon.filename = 'data/wiktionary_bilexicon_en-es.mat'; 
            
            source.filename = sname;
            target.filename = tname;
            lexicon.filename = lname;
